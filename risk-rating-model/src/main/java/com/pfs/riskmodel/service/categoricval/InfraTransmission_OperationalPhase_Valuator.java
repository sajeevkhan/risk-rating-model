...
import com.pfs.riskmodel.businessconfig.Infra_Transmission_OperationalPhaseGrade;
...
public class InfraTransmission_OperationalPhase_Valuator {
    ...
    public RiskModelTemplate valuate (RiskModelTemplate riskModelTemplate) {
        ...
        for (RiskType riskType : riskModelTemplate.getRiskTypes()) {
            if (riskType.getDescription().contains("Post")) {
                 ...
                 ProjectGrade projectGrade =
                        Utils.fetchGrade(Infra_Transmission_OperationalPhaseGrade.projectGradeList,riskType.getScore());
        ...
        ProjectGrade overallProjectGradeObject =
                     Utils.fetchGrade(Infra_Transmission_OperationalPhaseGrade.projectGradeList,overallProjectScore);
        ...
        ProjectGrade modProjectGrade =  Utils.getProjectGradeByCommonScaleGrade(Infra_Transmission_OperationalPhaseGrade.projectGradeList,
        ...
        ProjectGrade afterParentalNotchUpGradeObject =
                Utils.getProjectGradeByGradeAsNumber( Infra_Transmission_OperationalPhaseGrade.projectGradeList, afterParentNotchupGradeAsNumber);
