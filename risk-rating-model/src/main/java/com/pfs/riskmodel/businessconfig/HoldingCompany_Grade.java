...
public class HoldingCompany_Grade implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        ProjectGrade p5 = new ProjectGrade(5,"9",4.25,5.00,"Sub Investment","GRADE 7",7);
        ProjectGrade p6 = new ProjectGrade(6,"9",5.00,5.75,"Investment","GRADE 6",6);
        ProjectGrade p7 = new ProjectGrade(7,"9",5.75,6.50,"Investment","GRADE 6",6);
        ProjectGrade p8 = new ProjectGrade(8,"9",6.50,7.50,"Investment","GRADE 5",5);
        ProjectGrade p9 = new ProjectGrade(8,"9",7.50,8.50,"Investment","GRADE 4",4);
        ProjectGrade p10 = new ProjectGrade(8,"9",8.50,10.0,"Investment","GRADE 3",3);
