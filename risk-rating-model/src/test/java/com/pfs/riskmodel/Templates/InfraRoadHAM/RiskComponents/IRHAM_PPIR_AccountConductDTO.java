package com.pfs.riskmodel.Templates.InfraRoadHAM.RiskComponents;
 ...
 */
public class IRHAM_PPIR_AccountConductDTO {
    ...
    public RiskComponentDTO getAccountConductDTO() {
        ...
        trendInWorkCapitalRiskSubFactorDTO.setWeightage(0.40);
