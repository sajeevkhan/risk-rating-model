package com.pfs.riskmodel.Templates.InfraRoadToll.RiskComponents;
 ...
 */
public class IRToll_PIR_CompletionRiskDTO {
    ...
    public RiskComponentDTO getCompletionRiskDTO() {
        ...
        //Completion Risk Component 40.00%
        ...
        fundingRiskFactorDTO.setWeightage(0.30D);
        ...
        clearancesRiskSubFactorDTO.setWeightage(0.43);
        ...
        landAcqusitionRiskSubFactorDTO.setWeightage(0.57);  // Does not matter
