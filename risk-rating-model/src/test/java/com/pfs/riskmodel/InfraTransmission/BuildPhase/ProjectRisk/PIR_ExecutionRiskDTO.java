 ...
 */
public class PIR_ExecutionRiskDTO {
    ...
    public RiskComponentDTO getExecutionRiskDTO() {
        ...
        riskSubFactorAttributes.add(new RiskAttribute(2D,"Experience in infrastructure construction exists but new entrant in transmission"));
        riskSubFactorAttributes.add(new RiskAttribute(4D,"Experience in infrastructure construction exists but new entrant in transmission"));
        riskSubFactorAttributes.add(new RiskAttribute(6D,"Good experience in projects of similar nature"));
        riskSubFactorAttributes.add(new RiskAttribute(8D,"Very good experience in projects of similar nature"));
        riskSubFactorAttributes.add(new RiskAttribute(10D,"Sponsor/contractor with extensive international / national experience"));
        ...
        riskSubFactorAttributes.add(new RiskAttribute(8D,"With ISO - Timelines were not breached during previously undertaken projects"));
        riskSubFactorAttributes.add(new RiskAttribute(10D,"Without ISO - Timelines were not breached during previously undertaken projects"));
        ...
        // -> Four Attributes
        riskSubFactorAttributes = new HashSet<>();
        riskSubFactorAttributes.add(new RiskAttribute(0D, "More than 80% of towers are located in difficult terrain (high altitude) Extreme weather (Rainy/Snow fall area)"));
        riskSubFactorAttributes.add(new RiskAttribute(3D,"Between 50-80% of towers are located in difficult terrain (high altitude) Extreme weather (Rainy/Snow fall area)"));
        riskSubFactorAttributes.add(new RiskAttribute(7D,"Between 10-50% of towers are located in difficult terrain (high altitude) Extreme weather (Rainy/Snow fall area)"));
        riskSubFactorAttributes.add(new RiskAttribute(10D,"Less than 10% of towers are located in difficult terrain (high altitude) Extreme weather (Rainy/Snow fall area)"));
        ...
        riskSubFactorAttributes.add(new RiskAttribute(3D,"Performance guarantee & Liquidate damages are as per industry practice and Partially covers developer's liability (less than 50% payable to relevant authority by the concerned developer) arising due to delay in project execution, as stipulated in TSA."));
        riskSubFactorAttributes.add(new RiskAttribute(7D,"Performance guarantee & Liquidate damages are as per industry practice and covers developer's liability (50% to 100%, payable to relevant authority by the concerned developer) arising due to delay in project execution, as stipulated in TSA."));
        riskSubFactorAttributes.add(new RiskAttribute(10D,"Performance guarantee & Liquidate damages are as per industry practice and adequately 100% or more, payable to relevant authority by the concerned developer covers developer's liability arising due to delay in project execution, as stipulated in TSA."));
