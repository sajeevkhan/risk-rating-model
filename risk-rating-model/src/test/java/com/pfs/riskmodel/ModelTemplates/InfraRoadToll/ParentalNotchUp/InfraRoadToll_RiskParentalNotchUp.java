package com.pfs.riskmodel.ModelTemplates.InfraRoadToll.ParentalNotchUp;
 ...
 */
public class InfraRoadToll_RiskParentalNotchUp {
    ...
    public RiskParentalNotchUpDTO getInfraRoadToll_ParentalNotchup(){
