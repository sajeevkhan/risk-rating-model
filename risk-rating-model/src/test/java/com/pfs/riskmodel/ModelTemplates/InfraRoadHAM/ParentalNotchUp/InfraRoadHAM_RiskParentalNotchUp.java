package com.pfs.riskmodel.ModelTemplates.InfraRoadHAM.ParentalNotchUp;
 ...
 */
public class InfraRoadHAM_RiskParentalNotchUp {
    ...
    public RiskParentalNotchUpDTO getInfraRoadHAM_ParentalNotchup(){
        ...
        riskParentalNotchUpConditionDTO.setValue("2");
