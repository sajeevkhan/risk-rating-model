...
import com.pfs.riskmodel.Evaluations.Eval_InfraRoadToll.Evaluate_InfraRoad_Toll_BuildPhaseData;
 ...
 */
public class EVAL_TRANS_BUILD_ModelControllerTest extends AbstractTest {
    ...
    public void evaluate_INFRA_TRANS () throws Exception {
        ...
        Evaluate_Transmission_BuildPhaseData evaluate_transmission_buildPhaseData =
                new Evaluate_Transmission_BuildPhaseData() ;


        riskModelTemplateDTO = evaluate_transmission_buildPhaseData.getTransmission_BuildPhaseData();
